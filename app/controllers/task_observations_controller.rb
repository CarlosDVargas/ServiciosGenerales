class TaskObservationsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @observation.save
        format.html { redirect_to task_observation_url(@observation), notice: "Task observation was successfully created." }
  ...
  def update
    respond_to do |format|
      if @observation.update(task_observation_params)
        format.html { redirect_to task_observation_url(@observation), notice: "Task observation was successfully updated." }
